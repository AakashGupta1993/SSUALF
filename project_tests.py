...
def test_for_kitti_dataset(data_dir):
    ...
    training_labels_count = len(glob(os.path.join(kitti_dataset_path, 'training/gt_image_2/*_road_*.jpg')))
    training_images_count = len(glob(os.path.join(kitti_dataset_path, 'training/image_2/*.jpg')))
    testing_images_count = len(glob(os.path.join(kitti_dataset_path, 'testing/image_2/*.jpg')))
    
    print('training_labels_count : ', training_labels_count)
    print('training_images_count : ', training_images_count)
    print('testing_images_count : ', testing_images_count)
    ...
    assert training_images_count == 376, 'Expected 289 training images, found {} images.'.format(training_images_count)
    assert training_labels_count == 376, 'Expected 289 training labels, found {} labels.'.format(training_labels_count)
    assert testing_images_count == 51, 'Expected 290 testing images, found {} images.'.format(testing_images_count)
